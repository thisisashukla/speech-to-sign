  ...
  render() {
    return (
      ...
      <div class="row">
        ...
        <div id="gif" class="col s6">
          <div class="row">
            <div heigh="360px" width="360px"><Gif/></div>
          </div>
        </div>
      </div>
        <div align="center" padding-top="50px">
          <Tag>Made with ❤ at <a href="http://www.csre.iitb.ac.in/"><FooterImage src={images.csreLogo}/></a> by <a href="https://daas-ankur-shukla.github.io/" style={{ textDecoration: 'none' }}>Ankur</a><a> & Bodhisattwa</a></Tag>
        </div>
